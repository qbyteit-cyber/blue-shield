...
export const auditsPageMeta: PageMeta = {
    ...
    ctaSecondary: { text: "Download Audit Readiness Guide", href: "/contact" },
    trustPoints: [
    ...
    introParagraphs: [
        ...
        "ITIS's audit services are independent, rigorous internal assessments conducted by the same people who prepare clients for official certification. Our auditors know what VDA ISA assessors look for, what ISO 27001 auditors scrutinise first, and where companies consistently fail.",
