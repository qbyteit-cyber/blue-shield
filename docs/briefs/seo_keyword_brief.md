# SEO & KEYWORD ARCHITECTURE — ITIS SECURE

**INDUSTRY FOCUS:** Automotive + Defence & Aerospace
**STRATEGY:** Topical Authority Cluster (Pillar/Support)

---

## 1. KEYWORD MAP — TOP-LEVEL
...
## 2. SITE ARCHITECTURE & URL SLUGS

- **Pillar 1: Automotive**
  - `/industries/automotive`
  - `/services/tisax-al3-readiness`
...
- All blog posts must link to at least 2 relevant service pages.
- The "System Status" widget on the homepage will link to a "Live Compliance Map" (Phase 2).
- Footer will contain an "Expertise Archive" (Sitemap link).

---

## 6. LSI KEYWORDS (Must Include)
- ENX Portal, VDA ISA, CUI protection, DoD supply chain, Gap remediation, SSP development.
